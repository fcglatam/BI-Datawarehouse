...
for i, cada_fila in archivos_df.iterrows():
    print(cada_fila.fecha)
    inventario_1  = sheets_leer_inventario(servicio_sheet, 
        cada_fila.id, cada_fila.fecha)              
...
#%% 3.5 Corregir Inventario Fechas

date_cols = ["incoming_date"]  # Only one in this case.
  
inventario_df_mod = inventario_df.replace(
    {"incoming_date" : {np.nan: None, '': None} })
...
inventario_df_mod.to_sql("cars_inventory", 
